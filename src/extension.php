...
namespace awsmug\TorroFormsDoubleOptIn;
...
class Extension extends Extension_Base {
	...
	protected function load_base_properties() {
		...
		$this->project_name = 'TorroFormsDoubleOptIn';
	}
	...
	protected function load_textdomain() {
		$this->load_plugin_textdomain( 'torro-forms-double-opt-in', '/languages' );
	}
	...
	protected function instantiate_services() {
		...
		$this->parent_plugin->template()->register_location( 'torro-forms-double-opt-in', $this->path( 'templates/' ) );
	}
	...
	protected function register_date_element_type( $element_type_manager ) {
		$element_type_manager->register( 'autocomplete', 'awsmug\TorroFormsDoubleOptIn\Element_Types\Autocomplete' );
		$element_type_manager->register( 'date', 'awsmug\TorroFormsDoubleOptIn\Element_Types\Date' );
	}
